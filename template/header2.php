<nav class="container navbar navbar-expand-lg navbar-custom pt-0 pb-0">
    ...
    <button class="btnMenu d-xxl-none d-xl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
    ...
    <div class="offcanvas offcanvas-end d-xxl-none d-xl-none" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="background-image: var(--fondo-menu);">
        ...
        <div class="offcanvas-body d-block d-lg-none text-start">
            <ul class="container col-sm-12 navbar-nav me-auto ps-3">
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="index.php#home">HOME</a></button>
                </li>
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="ourFirm.php#ourFirm">OUR FIRM</a></button>
                </li>
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="businesses.php#businesses">BUSINESSES</a></button>
                </li>
                <li class="pt-4 pe-4">
                ...
                <li class="pt-4 pe-4">
                    <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light animate__animated animate__backInRight animate__delay-1s animate__fast" style="color: var(--link) !important" href="contact.php#contact">CONTACT</a></button>
                </li>
                <li class="pt-5 pe-4">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
            <li class="pt-4 pe-4">
                <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light" style="color: var(--title-color) !important" href="ourFirm.php#ourFirm">OUR FIRM</a></button>
            </li>
            <li class="pt-4 pe-4">
                <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light" style="color: var(--title-color) !important" href="businesses.php#businesses">BUSINESSES</a></button>
            </li>
            <li class="pt-4 pe-4">
            ...
            <li class="pt-4 pe-4">
                <button class="btn-nav btn rounded-pill btn-lg"><a class="nav-link fw-light" style="color: var(--title-color) !important" href="contact.php#contact">CONTACT</a></button>
            </li>
        </ul>
    </div>
</nav>