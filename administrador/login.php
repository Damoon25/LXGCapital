            ...
            <div class="card card-login rounded-4 " data-aos="flip-left">
                <div class="card-header">
                    <div class="container-sm text-center pt-2 pb-2">
                        <h2 style="text-align:center; font-size:larger; color: var(--text1);">INICIAR SESIÓN</h2>
                    </div>
                </div>
                <div class="card-body">
                    <div class=" col-sm-12 col-md-12 d-flex justify-content-center align-self-center me-2">
                        <img src="../public/img/logoBlack.svg" id="logoAdmin" alt="logo" class="img-fluid">
                    </div>
                    <form method="POST" class="container-sm-fluid text-center">
                        ...
                        <!-- <div class="mb-4">
                            <a href="register.php"><button type="button" id="register" class="boton-Register form-control btn rounded-pill btn-lg" style="background-color: #ffff;" name="accion" value="login">CREA TU CUENTA</button></a>
                        </div> -->
                        <div class="mb-4">
                            <div class="mb-3 mt-3">
                                <?php
